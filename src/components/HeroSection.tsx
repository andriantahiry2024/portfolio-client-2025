        ...
        <div className="w-full md:flex-1 px-4 py-8 md:p-8 relative z-10 flex flex-col justify-center">
          <div className="w-full max-w-[90%] sm:max-w-md md:max-w-lg">  {/* Improved container constraints */}
            <motion.h1 
              ...
              className="text-2xl xs:text-3xl md:text-4xl lg:text-5xl text-white font-bold leading-tight break-words hyphens-auto"
            >
              {name}
            </motion.h1>
            <motion.h2 
              ...
              className="text-base xs:text-lg md:text-xl lg:text-2xl font-medium text-white mb-3 md:mb-6"
            >
              {title}
            </motion.h2>
            <motion.p 
              ...
              className="text-xs xs:text-sm md:text-base text-neutral-300 break-words"
            >
              {description}
            </motion.p>
          </div>
          <div className="flex flex-wrap items-center gap-2 md:gap-4 mt-3 md:mt-4">
            <motion.button
              ...
              onClick={onCtaClick}
              className="mt-2 md:mt-4 px-3 md:px-6 py-1.5 md:py-3 text-xs sm:text-sm md:text-base rounded-lg bg-white text-black font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-white/20"
            >
              {ctaText}
            </motion.button>
            <motion.button
