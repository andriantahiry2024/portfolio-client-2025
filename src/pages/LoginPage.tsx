...
const LoginPage: React.FC = () => {
  ...
  const onSubmit = async (values: LoginFormValues) => {
    ...
    try {
      ...
      // localStorage.setItem('userData', JSON.stringify(data.user)); // NE PLUS Stocker les infos utilisateur ici
      ...
      navigate('/admin');
      // // Logique précédente basée sur les rôles (commentée car le backend ne renvoie plus de rôle)
